...
#function that is going to collect %change and make patterns in the tick data
def patternStorage():
...
'''    
-31 would be first element (start point), -30 (2nd),
-1 would be first. So moving from point 1 to 2 to 3, etc
'''
...
def graphRawFX():
    ...
    ax1_2 = ax1.twinx()
    ax1_2.fill_between(date, 0, (ask-bid), facecolor='g',alpha=.3) #ask-bid = spread
